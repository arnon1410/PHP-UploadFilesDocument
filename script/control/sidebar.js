function fnSetSidebarMenuConTrol(namePages){
    ...
    for (var i = 0; i < menuItemsMain.length; i++) {
        ...
        strHTML += `<li><a href='${menuItemA.page}.php' class='nounderline${isActive}'><span class='${menuItemA.icon}'></span><span>${menuItemA.text}</span></a></li>`;
    }
    ...
    for (var i = 0; i < menuItemsForm.length; i++) {
        ...
        strHTML += `<li><a href='${menuItemB.page}.php' class='nounderline${isActive}'><span class='${menuItemB.icon}'></span><span>${menuItemB.text}</span></a></li>`;
    }
