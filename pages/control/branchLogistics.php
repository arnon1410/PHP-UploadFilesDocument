...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchLogistics')
        fnCreateBtnTabForm('branchLogistics')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านส่งกำลังบำรุง', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านส่งกำลังบำรุง', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านส่งกำลังบำรุง', listControl: 'แบบ ปม.'}
