...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchFinanceAndAcc')
        fnCreateBtnTabForm('branchFinanceAndAcc')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านการเงินและการบัญชี', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านการเงินและการบัญชี', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านการเงินและการบัญชี', listControl: 'แบบ ปม.'}
