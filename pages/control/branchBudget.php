...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchBudget')
        fnCreateBtnTabForm('branchBudget')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านการงบประมาณ', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านการงบประมาณ', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านการงบประมาณ', listControl: 'แบบ ปม.'}
