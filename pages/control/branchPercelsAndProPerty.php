...
<head>
    ...
    <title>ด้านพัสดุและทรัพย์สิน</title>
</head>
<body>
...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchPercelsAndProPerty')
        fnCreateBtnTabForm('branchPercelsAndProPerty')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านพัสดุและทรัพย์สิน', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านพัสดุและทรัพย์สิน', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านพัสดุและทรัพย์สิน', listControl: 'แบบ ปม.'}
