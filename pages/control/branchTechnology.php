...
<head>
    ...
    <title>ด้านระบบเทคโนโลยีในการบริหารจัดการ</title>
</head>
<body>
  ...
  <header>
    <div class="header-wrapper">
      ...
      <div class="header-title">
        <h1>ด้านระบบเทคโนโลยีในการบริหารจัดการ</h1>
...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchTechnology')
        fnCreateBtnTabForm('branchTechnology')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านระบบเทคโนโลยีในการบริหารจัดการ', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านระบบเทคโนโลยีในการบริหารจัดการ', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านระบบเทคโนโลยีในการบริหารจัดการ', listControl: 'แบบ ปม.'}
