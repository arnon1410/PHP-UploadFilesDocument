...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('referenceDoc')
        fnCreateBtnTabForm('referenceDoc')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'เอกสารอ้างอิง', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'เอกสารอ้างอิง', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'เอกสารอ้างอิง', listControl: 'แบบ ปม.'},
            {id: '4' , mainControl: 'เอกสารอ้างอิง', listControl: 'แบบ ปค.๔'},
            {id: '5' , mainControl: 'เอกสารอ้างอิง', listControl: 'แบบ ปค.๕'},
            {id: '6' , mainControl: 'เอกสารอ้างอิง', listControl: 'แบบติดตาม ปค.๕'}
