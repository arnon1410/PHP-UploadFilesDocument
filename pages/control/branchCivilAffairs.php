...
<div class="main-content">
  ...
  <main>
    ...
    <script src="../../script/control/7sides/drawTableFormNews.js.js"></script>
    <script src="../../script/control/sidebar.js"></script>
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchCivilAffairs')
        fnCreateBtnTabForm('branchCivilAffairs')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านกิจการพลเรือน', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านกิจการพลเรือน', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านกิจการพลเรือน', listControl: 'แบบ ปม.'}
