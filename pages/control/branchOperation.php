...
<script>
    $(document).ready(function() {
        fnSetSidebarMenuConTrol('branchOperation')
        fnCreateBtnTabForm('branchOperation')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านยุทธการ', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านยุทธการ', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านยุทธการ', listControl: 'แบบ ปม.'}
