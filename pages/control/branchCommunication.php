...
<script>
    $(document).ready(function() {
        ...
        fnCreateBtnTabForm('branchCommunication')
    ...
    function fnGetDataInternalControl() {
        const data = [
            {id: '1' , mainControl: 'ด้านสื่อสาร', listControl: 'แบบสอบถาม'},
            {id: '2' , mainControl: 'ด้านสื่อสาร', listControl: 'แบบประเมินฯ'},
            {id: '3' , mainControl: 'ด้านสื่อสาร', listControl: 'แบบ ปม.'}
